...
bool ShaderProgram::set(std::string_view name, GLsizei count, bool transpose, const float *value) const
{
  ...
  auto &u = iter->second;
  switch (u.type) {
  case GL_FLOAT_MAT2: glUniformMatrix2fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT3: glUniformMatrix3fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT4: glUniformMatrix4fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT2x3: glUniformMatrix2x3fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT2x4: glUniformMatrix2x4fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT3x2: glUniformMatrix3x2fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT3x4: glUniformMatrix3x4fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT4x2: glUniformMatrix4x2fv(u.location, count, transpose, value); break;
  case GL_FLOAT_MAT4x3: glUniformMatrix4x3fv(u.location, count, transpose, value); break;
...
/*
all of the possible types as of 25.9.2021
GL_FLOAT
GL_FLOAT_VEC2
GL_FLOAT_VEC3
GL_FLOAT_VEC4
